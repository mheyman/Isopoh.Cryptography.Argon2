// <copyright file="TestVector.cs" company="Isopoh">
...
namespace Argon2TestVectorType  
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TestVector"/> class.
        /// </summary>
        ...
        public TestVector(
            ...
            int tagLength,
            string encodedTag) =>
            (this.Type, this.Version, this.IterationCount, this.MemoryKByteCount, this.Parallelism, this.Password, this.Salt,
                this.Secret, this.AssociatedData, this.TagLength, this.EncodedTag)
            = (type, version, iterationCount, memoryKByteCount, parallelism, password, salt, secret, associatedData,
                tagLength, encodedTag);
        ...
        /// </summary>
        public string EncodedTag { get; private set; }
    }
}